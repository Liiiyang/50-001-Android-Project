...
public class RecyclerAttraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ActionBar actionBar = getActionBar();  (Still Testing, trying to add a back button to title bar
    ...
    private void addattractionFromJson() {
        try {
            ...
            for (int i = 0; i < attractionJsonArray.length(); ++i) {
                ...
                Pojo pojo = new Pojo(attractionid,attractionName, attractionlocation,attractionaddress,attractionImageName,walkEdgeList,busEdgeList,taxiEdgeList);
